...
const Appointments = () => {
  ...
  // Function to fetch doctor info based on the ID in the URL
  ...
  {/*--below function triggers as page loads --*/}
  useEffect(() => {
    fetchDocInfo();
  }, [doctors, docId]);{/*--if any of these 2 datas change this function is executed --*/}
  useEffect(()=>{
    getAvailableSlots();
  }, [docInfo]);
    ...
    <div>
      ...
      <div className='flex items-center gap-3 w-full overflow-x-scroll mt-4'>
        {docSlots.length && docSlots[slotIndex].map((item, index)=>(
          <p onClick={()=>setSlotTime(item.time)} className={`texte-sm font-light flex-shrink-0 px-5 py-2 rounded-full cursor-pointer 
